...
void* NVDrv::AllocateKernelMemory(size_t size)
{
    // Implement kernel memory allocation logic
    // This is a simplified example, replace with appropriate kernel memory allocation if necessary
    return VirtualAlloc(nullptr, size, MEM_COMMIT | MEM_RESERVE, PAGE_READWRITE);
}

bool NVDrv::MakeMemoryExecutable(void* address, size_t size)
{
    // Implement logic to change memory permissions to executable
    // This is a simplified example, replace with appropriate method if necessary
    DWORD oldProtect;
